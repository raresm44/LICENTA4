...
namespace LICENTA4.Controllers
{
    public class DemoController : Controller
    {
        ...
        //posibil sa nu am nevoie de getul asta
        [HttpGet]
        ...
        public void Demo(FormCollection form)
        {
            try
            {
                ...
                string surl = "http://localhost:44369/Return/Return";  //Change the success url here depending upon the port number of your local system.
                string furl = "http://localhost:44369/Return/Return";  //Change the failure url here depending upon the port number of your local system.
